...
List<CompanyDetailsModel> companyDetailsModelFromJson(String str) =>
    List<CompanyDetailsModel>.from(
        json.decode(str).map((x) => CompanyDetailsModel.fromJson(x)));

String companyDetailsModelToJson(List<CompanyDetailsModel> data) =>
